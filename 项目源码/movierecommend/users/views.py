...
def recommend2(request):
    ...
    read_mysql_to_csv2('users/static/users_resulttable2.csv')  # 追加数据，提高速率
...
def get_conn():
    conn = pymysql.connect(host='127.0.0.1', port=3306, user='root', passwd='123456', db='haha', charset='utf8')
    return conn
